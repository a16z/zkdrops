...
## Useful commands 
- `yarn compile`: Compile
- `yarn start-backend`: Start local test chain
- `yarn deploy`: Deploy to local test chain
- `yarn start-client`: Start local client 
- *Workspace specific commands are available in corresponding READMEs*
