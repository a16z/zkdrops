 ...
 *    - output file will be the format described in the library MerkleTree object: https://github.com/a16z/zkdrops/zkdrops-lib/blob/main/src/MerkleTree.ts
 */ 
...
async function main() {
    ...
    let mt = await MerkleTree.createFromLeaves(commitmentsBigInt);
